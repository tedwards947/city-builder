 ...
 * A tall, monolithic glass skyscraper with a distinctive 
 * spire and high-tech status lights.
 */
export const CorporateTowerL3: VectorEntity = {
  ...
  draw: (ctx, ts, t, p, vibe) => {
    ...
    ctx.fillRect(sx, sy, 2, spireH + 2); // +2 for overlap into building body
